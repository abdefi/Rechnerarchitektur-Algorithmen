...
build_and_generate_objdump "bubble_sort" "${BUILD_DIR}/bubble_sort" "-g"
build_and_generate_objdump "bubble_sort_O1" "${BUILD_DIR}/bubble_sort_O1" "-O1"
build_and_generate_objdump "bubble_sort_O2" "${BUILD_DIR}/bubble_sort_O2" "-O2"
build_and_generate_objdump "bubble_sort_O3" "${BUILD_DIR}/bubble_sort_O3" "-O3"

# Apply chmod to object files
apply_chmod "bubble_sort" "${BUILD_DIR}/bubble_sort"
apply_chmod "bubble_sort_O1" "${BUILD_DIR}/bubble_sort_O1"
apply_chmod "bubble_sort_O2" "${BUILD_DIR}/bubble_sort_O2"
apply_chmod "bubble_sort_O3" "${BUILD_DIR}/bubble_sort_O3"

# Extract size information for each object file
bubble_sort_size=$(extract_size_info "bubble_sort" "${BUILD_DIR}/bubble_sort")
bubble_sort_O1_size=$(extract_size_info "bubble_sort_O1" "${BUILD_DIR}/bubble_sort_O1")
bubble_sort_O2_size=$(extract_size_info "bubble_sort_O2" "${BUILD_DIR}/bubble_sort_O2")
bubble_sort_O3_size=$(extract_size_info "bubble_sort_O3" "${BUILD_DIR}/bubble_sort_O3")
...
generate_gnuplot_script() {
    ...
    cat << EOF > "${data_file}"
bubble_sort ${bubble_sort_size}
bubble_sort_O1 ${bubble_sort_O1_size}
bubble_sort_O2 ${bubble_sort_O2_size}
bubble_sort_O3 ${bubble_sort_O3_size}
EOF
